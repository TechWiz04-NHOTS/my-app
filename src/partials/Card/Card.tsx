    ...
    return(
        <div>
            ...
            <div className="flex justify-center gap-[12px]">
              ...
              <div className="text-white flex items-center justify-center items-center gap-[24px]">
                <div className="flex gap-[24px]">
                    <p className="text-[12px] flex items-center"><strong>MAIN PARTNERS</strong></p>
                    <div className="w-[1px] bg-[hsla(0,0%,100%,.12)] h-[32px]"></div>
                </div>
                <img src="./image/190-1907978_spotify-logo-png-white-spotify-logo-white-transparent.png" width="100px"/>
                <svg className=" marketing-partners__logo marketing-partners__logo--nike w-[100px]" aria-hidden="true" viewBox="0 0 200 71.98">
