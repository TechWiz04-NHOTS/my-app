        ...
        <div className="flex flex-col bg-[#2a2a2a] mt-[50px]">
            <div className="flex gap-[24px] items-center text-center justify-center border-b py-[44px]">
                <div className="flex items-center gap-[12px] text-white">
                    <FaTwitter className="rounded-full bg-[#3f3f3f] p-[16px] w-[50px] h-[50px]" />  
                    <FaFacebookF className="rounded-full bg-[#3f3f3f] p-[16px] w-[50px] h-[50px]" />
                    <FaYoutube className="rounded-full bg-[#3f3f3f] p-[16px] w-[50px] h-[50px]" />
                    <FaInstagram className="rounded-full bg-[#3f3f3f] p-[16px] w-[50px] h-[50px]" />
                    <FaTiktok className="rounded-full bg-[#3f3f3f] p-[16px] w-[50px] h-[50px]" />  
                </div> 
            ...
            <div className="flex justify-between items-center bg-[#1a1a1a] px-[30px]">
                <div className="flex items-center gap-[20px] text-white font-[100] text-[14px] py-[12px]">
                    <p>Download App</p>
                    <p>Accessbility</p>
                    <p>Contact Us</p>
                    <p>Job & Careers</p>
