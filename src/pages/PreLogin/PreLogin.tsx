    ...
    return(
        <div className="bg-[#1a243e] w-[100%] h-[100vh]">
            <div className="flex flex-col items-center justify-center gap-[20px] pt-[100px] max-w-[330px] mx-auto">
                ...
                <p className="text-white bg-[#1a243e] absolute mt-[74px] px-[20px] font-bold">Or log in with your email</p>
                <input type="email" value={emailName} onChange={(e) => setEmailName(e.target.value)} className="w-[100%] mt-[12px] py-[10px] text-white rounded-sm pl-[12px] outline-none bg-[#1a243e] border" placeholder="Your email" />
